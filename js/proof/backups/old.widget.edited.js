var fomowidget = {
  ...
  fomowidget.settings = {
    ...
    widgetHtml:
      '<div id=cp-purchase-notification class="cp-purchase-notification"><div class="static"><div id="cp-widget-inner" class="cp-widget-inner"></div><span id=cp-widget-close class="cp-widget-close"></span></div></div>'
  };
